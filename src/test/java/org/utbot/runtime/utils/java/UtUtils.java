...
public final class UtUtils {
    ...
    public static void setField(Object object, String fieldClassName, String fieldName, Object fieldValue) throws ClassNotFoundException, NoSuchFieldException, NoSuchMethodException, IllegalAccessException, java.lang.reflect.InvocationTargetException {
        ...
        java.lang.reflect.Method methodForGetDeclaredFields481561753539900 = Class.class.getDeclaredMethod("getDeclaredFields0", boolean.class);
        methodForGetDeclaredFields481561753539900.setAccessible(true);
        java.lang.reflect.Field[] allFieldsFromFieldClass481561753547700 = (java.lang.reflect.Field[]) methodForGetDeclaredFields481561753539900.invoke(java.lang.reflect.Field.class, false);
        modifiersField = java.util.Arrays.stream(allFieldsFromFieldClass481561753547700).filter(field1 -> field1.getName().equals("modifiers")).findFirst().get();
    ...
    public static void setStaticField(Class<?> clazz, String fieldName, Object fieldValue) throws NoSuchFieldException, IllegalAccessException {
        ...
        try {
            ...
            java.lang.reflect.Method methodForGetDeclaredFields481561754755400 = Class.class.getDeclaredMethod("getDeclaredFields0", boolean.class);
            methodForGetDeclaredFields481561754755400.setAccessible(true);
            java.lang.reflect.Field[] allFieldsFromFieldClass481561754756400 = (java.lang.reflect.Field[]) methodForGetDeclaredFields481561754755400.invoke(java.lang.reflect.Field.class, false);
            modifiersField = java.util.Arrays.stream(allFieldsFromFieldClass481561754756400).filter(field1 -> field1.getName().equals("modifiers")).findFirst().get();
    ...
    public static Object getFieldValue(Object obj, String fieldClassName, String fieldName) throws ClassNotFoundException, NoSuchMethodException, java.lang.reflect.InvocationTargetException, IllegalAccessException, NoSuchFieldException {
        ...
        java.lang.reflect.Method methodForGetDeclaredFields481561756215600 = Class.class.getDeclaredMethod("getDeclaredFields0", boolean.class);
        methodForGetDeclaredFields481561756215600.setAccessible(true);
        java.lang.reflect.Field[] allFieldsFromFieldClass481561756216800 = (java.lang.reflect.Field[]) methodForGetDeclaredFields481561756215600.invoke(java.lang.reflect.Field.class, false);
        modifiersField = java.util.Arrays.stream(allFieldsFromFieldClass481561756216800).filter(field1 -> field1.getName().equals("modifiers")).findFirst().get();
    ...
    public static Object getStaticFieldValue(Class<?> clazz, String fieldName) throws IllegalAccessException, NoSuchFieldException {
        ...
        do {
            try {
                ...
                java.lang.reflect.Method methodForGetDeclaredFields481561757035300 = Class.class.getDeclaredMethod("getDeclaredFields0", boolean.class);
                methodForGetDeclaredFields481561757035300.setAccessible(true);
                java.lang.reflect.Field[] allFieldsFromFieldClass481561757035900 = (java.lang.reflect.Field[]) methodForGetDeclaredFields481561757035300.invoke(java.lang.reflect.Field.class, false);
                modifiersField = java.util.Arrays.stream(allFieldsFromFieldClass481561757035900).filter(field1 -> field1.getName().equals("modifiers")).findFirst().get();
    ...
    private static java.lang.invoke.MethodHandles.Lookup getLookupIn(Class<?> clazz) throws IllegalAccessException, NoSuchFieldException, NoSuchMethodException, java.lang.reflect.InvocationTargetException {
        ...
        java.lang.reflect.Method methodForGetDeclaredFields481561769053400 = Class.class.getDeclaredMethod("getDeclaredFields0", boolean.class);
        methodForGetDeclaredFields481561769053400.setAccessible(true);
        java.lang.reflect.Field[] allFieldsFromFieldClass481561769056500 = (java.lang.reflect.Field[]) methodForGetDeclaredFields481561769053400.invoke(java.lang.invoke.MethodHandles.Lookup.class, false);
        allowedModes = java.util.Arrays.stream(allFieldsFromFieldClass481561769056500).filter(field1 -> field1.getName().equals("allowedModes")).findFirst().get();


        java.lang.reflect.Method methodForGetDeclaredFields481561769063100 = Class.class.getDeclaredMethod("getDeclaredFields0", boolean.class);
        methodForGetDeclaredFields481561769063100.setAccessible(true);
        java.lang.reflect.Field[] allFieldsFromFieldClass481561769063500 = (java.lang.reflect.Field[]) methodForGetDeclaredFields481561769063100.invoke(java.lang.invoke.MethodHandles.Lookup.class, false);
        allModesField = java.util.Arrays.stream(allFieldsFromFieldClass481561769063500).filter(field1 -> field1.getName().equals("ALL_MODES")).findFirst().get();
